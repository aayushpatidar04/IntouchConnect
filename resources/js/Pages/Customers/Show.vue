<template>
    <AppLayout :title="customer.name">
        ...
        <div class="flex flex-col md:flex-row h-[calc(100vh-56px)] overflow-hidden animate-fade-in">

            <!-- Sidebar -->
            <aside class="w-full md:w-72 shrink-0 border-r border-surface-100 bg-white flex flex-col overflow-hidden">
                ...
                <div class="border-t border-surface-100">
                    ...
                    <button @click="docsOpen = !docsOpen"
                        class="w-full flex items-center justify-between px-4 py-3 text-xs font-semibold text-surface-700 uppercase tracking-wider">
                        Documents ({{ localDocs.length }})
                        <!-- Arrow icon -->
                        <svg class="w-4 h-4 transform transition-transform" :class="{ 'rotate-180': docsOpen }"
                    ...
                    <transition name="accordion">
                        <div v-show="docsOpen" class="overflow-y-auto scrollbar-thin p-4 max-h-[40vh] md:max-h-[50vh]">
                            ...
                            <div v-for="doc in localDocs" :key="doc.id"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="text-xs font-medium text-surface-700 truncate">{{
                                ...
                                <div class="flex items-center gap-1.5 mt-2">
                                    ...
                                    <span :class="['badge text-[9px]', docStatusClass(doc.status)]">{{ doc.status
                                        }}</span>
